...
export interface ApiCategoriCategori extends Struct.CollectionTypeSchema {
  collectionName: 'categories';
  info: {
    description: '';
    displayName: 'Categories';
    pluralName: 'categories';
    singularName: 'categori';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    discount_categories: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::categori.categori'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
...
export interface ApiInvoiceInvoice extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    final_price: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::invoice.invoice'
    > &
      Schema.Attribute.Private;
    normal_price: Schema.Attribute.Integer;
    orders: Schema.Attribute.Relation<'oneToMany', 'api::order.order'>;
    payment_method: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    shipping_cost: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user: Schema.Attribute.Relation<
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    order_status: Schema.Attribute.Enumeration<
      ['Pending', 'Packed', 'Sent', 'Success', 'Cancelled', 'Cart']
    >;
    payment_status: Schema.Attribute.Enumeration<['Unpaid', 'Paid']>;
    publishedAt: Schema.Attribute.DateTime;
    token_payment: Schema.Attribute.String;
...
export interface ApiShopSettingShopSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    binderbyte: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSlideshowSlideshow extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    status_show: Schema.Attribute.Enumeration<['active', 'nonactive']>;
    thumbnail: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::categori.categori': ApiCategoriCategori;
